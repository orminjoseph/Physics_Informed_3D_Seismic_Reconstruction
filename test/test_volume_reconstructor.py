...
Tests full-volume reconstruction using:
...
# The current synthetic configuration does not define a
# separate synthetic stride.
#
# Therefore, use non-overlapping patches for this test.
#
# This produces one patch for a volume of the same size.
PATCH_SIZE = SYNTHETIC_PATCH_SIZE
PATCH_STRIDE = SYNTHETIC_PATCH_SIZE
...
def test_volume_reconstructor():
    ...
    # --------------------------------------------------------
    # The VolumeReconstructor now expects the authoritative
    # MCDropout3D predictor interface.
    #
    # It returns:
    #
    ...
    print()
    print("=" * 60)
    print("VOLUME RECONSTRUCTOR TEST: PASSED")
    print("=" * 60)
